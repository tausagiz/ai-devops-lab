...
The GitHub Actions test and docs-check workflows use minimal repository permissions (`contents: read`) because they only need checkout access to run validation.
